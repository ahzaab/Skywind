...
{ 
  /* CONSTANTS */
	...
	private static var STATE_LEGEND= 3;
  ...
  /* PRIVATE VARIABLES */
	...
	private var _bRequestLegendLoc: Boolean = false;
  ...
  /* PUBLIC FUNCTIONS */
	...
	public function Show(a_bShow: Boolean): Void
	{
		...
		if (a_bShow) {
			...
			else if (_bRequestLegendLoc)
				setState(STATE_LEGEND);
			else
	...
	public function setLegend(a_legend: Legend): Void
	{
		_legend = a_legend;
	}
  ...
  /* PRIVATE FUNCTIONS */
	...
	private function setState(a_newState: Number): Void
	{
		...
		if (a_newState == STATE_LOCALMAP) {
			...
			buttonPanel.button4.disabled = true;
			...
			buttonPanel.button7.visible = false;
			buttonPanel.button7.disabled = true;
			...
			buttonPanel.button.visible = false;
			
		}
		else if (a_newState == STATE_LEGEND) {
			updateLocalMapExtends(false);
			if (oldState == STATE_LOCALMAP) {
				_parent.gotoAndPlay("fadeOut");
				_parent._visible = true;
			...
			buttonPanel.button6.visible = false;
			buttonPanel.button4.visible = true;
			buttonPanel.button4.disabled = false;
			buttonPanel.button7.visible = true;
			buttonPanel.button7.disabled = false;
		}
