...
class ContainerMenu extends ItemMenu
{
	...
	function UpdateItemCardInfo(aUpdateObj: Object): Void
	{
		...
		if (aUpdateObj.pickpocketChance != undefined) {
			...
			ItemCardFadeHolder_mc.StealTextInstance.PercentTextInstance.htmlText = "<font face=\'$EverywhereBoldFont\' size=\'24\' color=\'#F9EDD5\'>" + aUpdateObj.pickpocketChance + "%</font>" + (isViewingContainer() ? _root.TranslationBass.ToStealTextInstance.text : _root.TranslationBass.ToPlaceTextInstance.text);
			return;
		}
		ItemCardFadeHolder_mc.StealTextInstance._visible = false;
	}
