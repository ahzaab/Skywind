...
class BottomBar extends MovieClip
{
  ...
  /* PUBLIC FUNCTIONS */
	...
	{
		playerInfoCard.gotoAndStop("Crafting"); //changed since we don't have crafting skills anymore
		updateSkillBar(a_skillName, a_levelStart, a_levelPercent);
		
	}
	
	public function UpdateCraftingInfo2(a_skillName: String, a_levelStart: Number, a_levelPercent: Number): Void
	{
		playerInfoCard.gotoAndStop("Crafting"); //changed since we don't have crafting skills anymore
		updateSkillBar(a_skillName, a_levelStart, a_levelPercent);
