...
class skyui.components.TabBar extends MovieClip
{
  ...
  /* INITIALIZATION */
	...
	public function onLoad(): Void
	{
		...
		{
			this._parent.tabPress(this.LEFT_TAB);
		};
		...
		{
			if (this._parent._activeTab != this.LEFT_TAB) {
		...
		{
			this._parent.tabPress(this.RIGHT_TAB);
		};
		...
		{
			if (this._parent._activeTab != this.RIGHT_TAB) {
