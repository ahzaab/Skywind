...
class Map.Legend extends MovieClip
{
  /* CONSTANTS */
  ...
  /* PRIVATE VARIABLES */
	...
	private var _visiblilityList:Array;

    private var _Map : MapMenu;
  /* STAGE ELEMENTS */
  ...
  /* INITIALIZATION */
	...
	private function onLoad(): Void
	{
		...
		list.addEventListener("itemPress", this, "onLegendPress");
  ...
  /* PUBLIC FUNCTIONS */
	...
	public function setVisibilityArray(vis : Array) :Void
	{
		_visiblilityList = vis;
	}
	
	public function setMapMenu(mapmenu : MapMenu) :Void
	{
		_Map=mapmenu;
	}
  ...
  /* PRIVATE FUNCTIONS */
	...
	private function onLegendPress(a_event: Object): Void
	{
		...
		_visiblilityList[entry.index] = Math.abs(_visiblilityList[entry.index] -1);
		list.entryList[entry.index].IconClip.gotoAndStop(93);
		list.selectedClip.changeIcon(93);
		_Map.RefreshVisibilityMarkers(_visiblilityList);
