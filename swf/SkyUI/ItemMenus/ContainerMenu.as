  ...
  /* PUBLIC FUNCTIONS */
	...
	public function UpdateItemCardInfo(a_updateObj: Object): Void
	{
		...
		if (a_updateObj.pickpocketChance != undefined) {
			...
			itemCardFadeHolder.StealTextInstance.PercentTextInstance.htmlText = "<font face=\'$EverywhereBoldFont\' size=\'24\' color=\'#F9EDD5\'>" + a_updateObj.pickpocketChance + "%</font>" + (isViewingContainer() ? Translator.translate("$ TO STEAL") : Translator.translate("$ TO PLACE"));
		} else {
			itemCardFadeHolder.StealTextInstance._visible = false;
		}
	}
