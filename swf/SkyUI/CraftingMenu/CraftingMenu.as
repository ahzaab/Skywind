...
import skyui.ItemMenus.BottomBar;
...
//		BottomBarInfo["Button" + CraftingMenu.AUX_BUTTON].disabled = false;
	...
	//@API
	//public function FixSkill(a_skillName: String, a_levelStart: Number, a_levelPercent: Number): Void
	//{
		//BottomBar.UpdateCraftingInfo2(a_skillName, a_levelStart, a_levelPercent)
	//}
