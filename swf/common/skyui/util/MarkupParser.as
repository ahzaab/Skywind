...
class skyui.util.MarkupParser
{
	...
	public static function initialize(): Boolean
	{
		...
		styleSheet.setStyle("p", {color: "#F9EDD5 ", fontSize: "17px"});
		styleSheet.setStyle(".list", {color: "#F9EDD5 ", fontSize: "17px", textIndent: "10px"});
		styleSheet.setStyle("bullet", {color: "#F9EDD5 ", fontSize: "20px"});
		...
		styleSheet.setStyle("a:link", {color: "#F9EDD5 ", textDecoration: "none"});
		styleSheet.setStyle("a:hover", {color: "#F9EDD5 ", textDecoration: "underline"});
		styleSheet.setStyle("a:active", {color: "#F9EDD5 ", textDecoration: "underline"});
		styleSheet.setStyle("h1", {color: "#F9EDD5 ", fontSize: "28px"});
		styleSheet.setStyle("h2", {color: "#F9EDD5 ", fontSize: "24px"});
		styleSheet.setStyle("h3", {color: "#F9EDD5 ", fontSize: "18px"});
